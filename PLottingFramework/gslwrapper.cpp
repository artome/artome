...
// stats package
double GslWrapper::vector_mean(std::vector<double> *vec)
{
    size_t n=vec->size();
    if (n==0){
...
double GslWrapper::vector_median(std::vector<double> *vec)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
double GslWrapper::vector_std(std::vector<double> *vec,double mean)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
double GslWrapper::vector_max(std::vector<double> * vec)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
double GslWrapper::vector_min(std::vector<double> *vec)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
void   GslWrapper::vector_maxmin(std::vector<double> *vec, double *min, double *max)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
size_t    GslWrapper::vector_max_index(std::vector<double> *vec )
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
size_t    GslWrapper::vector_min_index(std::vector<double> *vec)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
void   GslWrapper::vector_maxmin_index(std::vector<double> *vec, size_t* imin, size_t* imax)
{
    size_t n=vec->size();
    if (n==0){
        error="sizeof vector was 0";
...
double  GslWrapper::vector_trimMean(std::vector<double> *vec, double alpha)
{
    size_t n=vec->size();
    if (n==0){
      //  error="sizeof vector was 0";
    ...
    double mean=gsl_stats_trmean_from_sorted_data(alpha,&vec->at(0),1,n);
    return mean;
...
int GslWrapper::Movingpolynomialfit(std::vector<double> *vecx,std::vector<double> *vecy,
